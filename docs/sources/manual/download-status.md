...
| 자료 | 로컬 확보 결과 | 확인 |
| --- | --- | --- |
| M-01 Parker `HY29-0035-M1/UK` | **로컬 확보(2026-09-21), git 미포함.** [공식 원문](https://www.parker.com/content/dam/Parker-com/Literature/PMDE/Service_Manuals/Vane_Pumps/HY29-0035-UK.pdf) 링크 제공 | 2,589,764 bytes, 파일 헤더 `%PDF-1.6` 확인. 파일명 `parker-hpu-고장-HY29-0035-UK.pdf`. 재배포 권한 미확인이라 `.gitignore`로 제외, 공유 드라이브로 전달 |
| M-04 Siemens SINAMICS G120 CU240B/E-2, 01/2012 | [로컬 PDF](siemens-G120-CU240BE2-LH11-0112-en.pdf) | 4,031,162 bytes, 파일 헤더 `%PDF-1.6` 확인 |
...
**git 포함 기준**: 공공기관 발행 자료만 리포에 넣는다. 제조사·민간 자료는 재배포 권한이 확인되기 전까지 로컬(`.gitignore`)에만 두고 공유 드라이브로 전달한다. 이미 커밋된 M-04 Siemens PDF는 별도 확인 대상이다.

PDF 확인은 다운로드 성공·파일 크기·형식 헤더에 대한 확인이며 전체 페이지의 렌더링 검수는 아니다. 원문 파일은 수정하지 않았다.
